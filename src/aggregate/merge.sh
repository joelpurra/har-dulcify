...
def mangle(halfway):
	...
	| .url.domain."public-suffices" |= mergeKeyCounterObjects($halfway.url.domain."public-suffices")
	| .referer.domain.value |= mergeKeyCounterObjects($halfway.referer.domain.value)
	| .referer.domain."public-suffices" |= mergeKeyCounterObjects($halfway.referer.domain."public-suffices")
